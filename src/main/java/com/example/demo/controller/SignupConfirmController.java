...
public class SignupConfirmController {
	...
	public String signupConfirm(String oneTimeCode, RedirectAttributes redirectAttributes) {
		var userid = (String) session.getAttribute(SessionKeyConst.ONE_TIME_AUTH_LOGIN_ID);
		if (userid == null) {
		...
		var signupConfirmStatus = service.chkTentativeSignupUser(userid, oneTimeCode);
